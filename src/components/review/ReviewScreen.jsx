    ...
    <div className="min-h-screen pb-32">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-10 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 relative z-10">
        ...
        <div className="lg:col-span-7 space-y-8 animate-[slide-up_0.8s_ease-out_both]" style={{ animationDelay: '0.1s' }}>
          ...
          {/* Judge impression */}
          <div className="glass-panel overflow-hidden rounded-[32px] relative p-8 md:p-10 group animate-[slide-up_0.8s_ease-out_both]" style={{ animationDelay: '0.3s' }}>
            {/* Decorative inner glass shine */}
            <div className="absolute top-[-50%] left-[-10%] w-[80%] h-[150%] bg-gradient-to-br from-white/50 to-transparent blur-3xl pointer-events-none -z-0 rotate-12" />

            <div className="flex items-center gap-3 mb-6 relative z-10">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/60 border border-white shadow-sm hidden md:flex">
              ...
              <h3 className="text-xl font-semibold tracking-tight text-text-primary">System Verdict</h3>
            </div>

            <div className="relative z-10">
              <svg className="absolute -top-3 -left-4 h-8 w-8 text-black/5 transform -scale-x-100 rotate-180" fill="currentColor" viewBox="0 0 32 32" aria-hidden="true">
